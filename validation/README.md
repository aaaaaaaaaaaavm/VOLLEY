...
| A74 | What the tube has to become, stated as a requirement rather than a material | numpy-free, importing `tube_shielding` and `array_drag` | the part of P92 that is a calculation | RUN 2026-08-31: band 1 passes by identity at exactly 0.0, bands 3 and 4 fail. **The tube's sheet conductance must fall to 657.2 S at the remanence and 4350.7 S at 0.20 T, 1.878 % to 12.430 % of the 1.0 mm aluminium wall's 35 000 S.** A liner needs 15.01 mm inside a 7.9025 mm bore radius and fits at two of six fields; thinning the aluminium needs 18.8 um against the 160 um the gas alone requires, 8.5x below it. So all three of P92's original candidates are gone and the material has to change or ADR-033 has to yield. No material is named: E11 owns the search against the number |
| A75 | Whether the decay model is the wrong shape or just at the wrong level | numpy, importing `astro` | the calculable half of P79 | RUN 2026-08-31: six of six. **E28's two GMAT reentries invert to uniform density scales of 1.9667 and 2.4443, agreeing to 1.2428x**, so one scalar explains both and `astro.py`'s piecewise-exponential shape was never the problem -- A50 published it at mean activity, x1.0, without saying so. Checked against evidence it was not fitted to: at the calibrated band 450 km lives 195.1 to 242.5 days against the 90 it survived. Re-quoted, 400 km is **77.5 to 96.3 days**, which straddles the 90-day campaign this project quotes. The 1.2428x residual is real, is probably inclination, and is what a variable-density atmosphere would explain |
| A76 | Whether inclination through a variable atmosphere explains A75's residual | `pymsis` NRLMSISE-00, numpy-free arithmetic around it | the named candidate in P79's residual | DECLARED 2026-09-15: bands frozen before `analysis/inclination_density.py` exists |
