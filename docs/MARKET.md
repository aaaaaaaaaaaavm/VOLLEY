...
Stated as a ratio against the incumbent ([A21](../validation/A21_comparators.md)): 7.33x
the orbital lifetime extension of the fastest published spring, 9.45x against a typical one, at
...
- At 3U it loses to a cold-gas module on mass by about 8x. 10.547 kg of deployer per satellite
...
|---|---|
| 3U / 6U | Per-satellite commanded velocity. Mass per satellite is at parity with a dispenser and loses to a propulsion module by 8.3x |
| 1U / PocketQube | Distribution at volume. Deployer mass per satellite falls by up to 30x, which is where the commercial case actually closes |
