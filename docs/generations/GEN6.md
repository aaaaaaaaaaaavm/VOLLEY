...
| Stroke | 2.18 m | |
| Dispersion, 3σ | **1.113 %** | against a declared 0.5 %. **93.4 % of the variance is seal friction** |
| Added mass per satellite | **1.403 kg** | **1.403–3.271 kg** once the stage credit is read hostilely — **P68** |
...
**The cradle** — 201.7 N per contact of preload releasing inside a ≤ 1 N residual, with no
mechanism in any file. **The piston, seals, valves and plumbing** — A41 allows 1.5 kg and designs
