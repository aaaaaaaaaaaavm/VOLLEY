...
| Per 3U satellite | 10.547 kg dry | crosses kill criterion 1 at 5.3x |
| Lifetime multiplier | x1.6 at mean activity | quoted at a stated activity level, not claimed invariant |
...
| Aerodynamics | OpenFOAM `simpleFoam`, k-ω SST, `snappyHexMesh` off the Gen5 sled STL. Mesh-converged: 6.3x the cells moves the answer 4.86 % |
| Orbit propagation | GMAT R2022a, headless, MSISE90 with 20x20 gravity, lunisolar third bodies and SRP, and it falsified a claim in this paper's own abstract |
...
offered as its defensible result, x1.80 at mean and high activity, x2.074 at low, an 18.5 %
...
And the corrections cost, every time. The sled went 4.86 to 9.445 kg from CAD solid volumes and
took exit velocity 20.37 to 16.388 m/s with it. A quadrature error took K_t 11.03 to 10.54 and every
...
Register reconciled 2026-09-14: 154 numbered entries, 53 live, 58 corrected and retained, 43 closed.
