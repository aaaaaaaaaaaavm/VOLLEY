...
> 1652 N first reported here assumed the magnetic-pressure ceiling and was 4.4x high, P50),
> and weighs
...
| Aluminium, 6061 or 7075 | A conductor, σ ~ 2 x 10⁷ S/m |
...
| Permanent magnets 20 mm from the payload at 442x a magnetometer's full scale, leaving soft-magnetic parts permanently altered (E35, P34) | No permanent magnets anywhere. An iron-cored stator has no residual dipole when off, so E33, the host wheel saturating in 3-7 days, has no source |
...
| Energy drawn per shot | 2782 J | 1182 J, 2.4x less |
...
| E35 / P34, the payload is magnetically modified, #5 | 442x magnetometer full scale at 20 mm | Iron-confined stator field, no magnets |
