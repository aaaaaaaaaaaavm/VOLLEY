...
provider's stated limit sits near that figure, VOLLEY's central number is non-compliant by 8x
...
acceptable, and a provider retains approval authority over any specific payload. An 8x
...
VOLLEY deploys at 16.029 m/s, 6.4x that ceiling.
