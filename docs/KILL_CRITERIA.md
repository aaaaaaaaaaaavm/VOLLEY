...
|---|---:|---:|---|
| 3U CubeSat | 12 | 12 | 10.550 kg, fails by 5.3x |
...
> 340.5 x 100 x 100 mm with class-specific inserts (ADR-025). Three consequences:
>
...
>
> ThinSat is refused outright. At 114 x 114 x 25.4 mm, two of its dimensions exceed the
...
zone, since the 539 mm of overhead does not shrink, and velocity goes as √s: 16.029 to 12.286 m/s,
−25 %, lifetime x1.60 to x1.43. Repackaging 150 mm of brake recovers about a third of that, and
...
| A single string of 32 x 190 F cells | 116 to 185 mΩ |
...
| What one shot buys | | |
|---|---|---|
| Orbital lifetime | x1.60 at mean activity | not invariant across solar activity (P16) |
...
> one degree costs 8.1x the entire shot. The 0.12° figure in the table above was an estimate
