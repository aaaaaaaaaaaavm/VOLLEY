...
| | | |
|---|---|---|
| **Strength** | Hoop stress is **17.96 MPa against a 250 MPa allowable — 13.9× margin.** | [A59](../../validation/A59_tube_structure.md) band 1. **Indifferent** |
...
| **Buckling** | 19.9 N against 57.7 N, and **both fail the unsupported case by 45× and 15×.** Support at 1.0 m is required either way | A59 bands 3, 4. **Indifferent in kind** |
