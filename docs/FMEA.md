...
>
> Nine shared elements x twelve cycles is 108 chances to fail.
...
|---|---:|
| On delivered orbital life (7.95 satellites suffice, since each is worth 1.495x) | r >= 0.99326 |
...
> and more total mission value, because each satellite it delivers is worth 1.495x a
...
1. The stator winding is segmented (`paper.tex` §VII, and P29 closed the modelling half).
   ...
   |---:|---:|---:|---:|
   | 4 | 325 mm | 14.19 m/s (86.6 %) | 1.41x a spring |
   | 8 | 162 mm | 15.33 m/s (93.6 %) | 1.45x a spring |
   | 12 | 108 mm | 15.69 m/s (95.8 %) | 1.47x a spring |
