...
| | |
|---|---|
| Design | Parametric only. ADR-025 fixed the cell at 340.5 x 100 x 100 mm; `parameters.json` marks it `PARAMETRIC_ONLY_NOT_DRAWN` |
...
1. ~~Velocity control.~~ Modelled 2026-08-16 by [A44](../validation/A44_gen6_dispersion.md),
   ...
   [A55](../validation/A55_trim_authority.md) re-ran it at ADR-034's 8.0 m, where it is 8x the
   declared band rather than 2x*, and 98.68 %
...
1. Design the per-cell backup ejector. [A47](../validation/A47_gen6_fmea.md) priced it at
   +2.27 satellites delivered at *r* = 0.99, against +0.37 for the entire Gen5 to Gen6
