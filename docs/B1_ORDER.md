...
|---|---|---|---:|---|
| **Type A** | 12 × 8 × 90 mm, N45SH | through the **8 mm** thickness | 4 | 2,000–4,000 |
| **Type B** | 12 × 8 × 90 mm, N45SH | along the **12 mm** length | 4 | 2,000–4,000 |
...
> "12 × 8 × 90 mm, N45SH" and nothing else will magnetise **through the largest face** — it is the
...
| Item | Spec | Qty | Est. INR |
|---|---|---:|---|
| Aluminium plate, fixture | 200 × 150 × 10 mm | 2 | 1,500 |
...
> Eight sintered NdFeB blocks, grade N45SH, each 12.0 × 8.0 × 90.0 mm.
...
3. **Measure one block's dimensions** against 12.0 × 8.0 × 90.0 mm and record the deviation. The
...
The two arrays attract. Over one wavelength at the design gap, Maxwell stress on 48 × 90 mm at
0.694 T gives
...
|---|---:|---:|---|
| Peak gap field | **0.694 T** | 4.4 % | within **±15 %** → 0.590 – 0.798 T |
| Winding mean \|B\| | **0.552 T** | 4.5 % | within **±15 %** → 0.469 – 0.635 T |
| Stray at 10 mm | **22.7 mT** | 3.7 % | within **±20 %** → 18.1 – 27.2 mT |
| Stray at 20 mm | **4.33 mT** | 4.2 % | within **±40 %** → 2.60 – 6.06 mT |
...
from `validation/bench/bench_predict.py` → `validation/results/bench_predictions.json`, which
