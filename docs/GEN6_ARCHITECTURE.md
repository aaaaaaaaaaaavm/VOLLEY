...
|---:|---:|---:|---:|
| 16.03 m/s | 10.1 g | 1300 mm | 1.00x |
| 16.03 m/s | 16.1 g | 850 mm | 0.65x |
| 16.03 m/s | 21.6 g | 634 mm | 0.49x |
| 20.00 m/s | 21.6 g | 944 mm | 0.73x |

PII-15's 2:1 reeving was recorded as "the only lever found that shortens the machine without
lengthening anything else", 1.30 m to 0.65 m. The margin does the same thing, for free, and
...
The brake run-out falls 240 to 105 mm, because arresting 0.6 kg at 200 g needs 1177 N over a
...
|---|---:|
| Net | −16.9 kg |
| Dry mass | 76.5 to 59.6 kg |
| Per 3U satellite | 6.378 to 4.967 kg |
| Against the ~2 kg threshold | still crossed, by 2.5x instead of 3.2x |
| Per PocketQube 1P, 288 per load (A24) | 0.207 kg, passes by 10x |
