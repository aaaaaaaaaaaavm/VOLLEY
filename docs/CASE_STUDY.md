...
gain against an unboosted satellite, VOLLEY is 7.33x a spring. On delivered orbital life,
which is what a risk-weighted comparison uses, it is 1.495x. Both are true. The second is the
...
| Magnetic environment | Severe, and currently a real cost. 61 mT at the near face, 611x a magnetometer's full scale. A magnetometer cannot be used inside the deployer, and soft-magnetic parts leave permanently magnetised |
...
- At 3U against a cold-gas module, VOLLEY loses on mass by 8.3x. The answer is smaller
