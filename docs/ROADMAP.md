...
| Efficiency | **18.8 %** electrical-to-payload, net of regeneration. *18.5 % is the gross figure and this row published it as the net one until 2026-08-21 (**P97**); the 240 mm regenerative section A11 measured against was shortened to 39 mm by ADR-030* |
| Validations run | **65 run sheets, A1 through A65** — A21-R and A45-R are re-runs — A3 and A26 were never written; A21-R is a re-run *(updated 2026-08-16; this line read "24, A1 through A27" for six days, and before that read "10 of 12" for three weeks. It is a hand-maintained count in a repository that generates its other counts, which is why it keeps going stale)* |
