...
> per-satellite mass 6.375 to 10.55 kg ([A46](../validation/A46_enclosure_buildup.md), P69),
> the regeneration credit 291.4 to 47.0 J after ADR-030 shortened the section from 240 mm to
> 39 mm (P97), and the constraint-ledger floor 49.23 to 88.67 kg (P95).
...
| A-3 | Ripple vs track modes | E23 | numpy | 6th harmonic sweeps 0 to 2048 Hz; track first mode is 109 Hz, so it crosses |
...
>
> P29 to [ADR-022](adr/022-stator-segmented-not-block-commutated.md). The winding is segmented
...
> +7.09 points of efficiency (20.99 to 28.07 %) and exactly zero exit velocity, because
...
>
> P9 to [ADR-023](adr/023-target-host-class.md). Target host is a spent upper stage or hosted
> platform of POEM class; ESPA-Grande port compliance is not a requirement. Shortening to fit
> was priced at −25 % exit velocity (16.029 to 12.286 m/s) and rejected. Kill criterion 2 is
...
Absent from the mass rollup. At a plausible 20 kg the per-satellite figure goes 6.375 to 8.08 kg
...
|---|---|---|
| Structural Q | 0.000 % | retention-gate margin +0.559 to −0.100, through zero |
| Brake pole field | 0.000 % | brake stopping distance 0.345 to 0.063 m against a 0.210 m section |
...
| | |
|---|---|
| P36, the track had no dynamic design case | A33, six of six bands. The mode does fall 109.0 to 66.4 Hz with the sled aboard, but the ripple chirp crosses it at x = 133 mm where the sled has depressed it 0.8 %, excitation and depression are separated in space, so A17's fixed-frequency treatment was adequate. The travelling load is 5.01 % of critical speed |
...
P46 applied, the thrust integral is depth-resolved, K_t 11.0258 to 10.5386, v_exit
16.388 to 16.029 m/s. P28, regen section 240 to 39 mm. P10, an 8.0 kg labelled
placeholder enters the rollup. P32, Gen4 retired.

> Every headline number moved the wrong way and nothing improved. Efficiency 21.0 to 18.8 %,
> kg per 3U satellite 6.378 to 7.042, kill criterion 1 from crossed by 3.2x to 3.5x. That
> is what taking these decisions cost, and it is why they had been deferred. This project's
> numbers have got worse every time they got truer, and 20.65 to 20.37 to 16.537 to 16.388 to
