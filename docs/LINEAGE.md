...
> | Mechanism integration, *how much of the machine the stage IS* | Changed enormously. Free-flyer to hosted deployer to self-contained electromagnetic system aboard the platform to a system whose structure and length are the stage's |
>
...
| mid-2025 | Coilgun to linear synchronous motor | A coilgun cannot command a velocity, and commanding it is the product |
