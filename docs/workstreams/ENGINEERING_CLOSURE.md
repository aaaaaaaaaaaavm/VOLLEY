...
1. Reconcile later evidence with open wording, especially P39 provenance, P56 free phasing baseline and BOLLEY's A9f/A5h versus earlier winding/circuit descriptions. Preserve failed runs and identify genuine remaining work.
2. Complete P57 full voice-coil prior-art review and E16 publisher-reference audit. Record actual duty, evidence and the required comparison fields. A missing full paper remains a source gap.
3. Produce reusable atmosphere/lifetime uncertainty (P79/E6/E28), covariance (E18), sensor selection (E7), supplier component/mass and material screening (E3/E11), with explicit configuration boundaries.
4. Correct the existing guide/contact model (P103/P108): continuous geometry, restitution, penetration, convergence, friction, compliance, inertia and tolerances. The historical tip-off magnitude is not settled physical truth.
5. Complete bounded existing-design backup/vessel/fill and inhibit work (P81/P91/P87/E32). Replacement trim design P117/P118 depends on the P92 selection; do not optimize a falsified combination as though it survived.
6. Complete applicable frozen Gen5 effects: winding inductance, magnetic exposure, dynamic track/segmentation, flywheel evidence, residual dipole, shock spectra, magazine indexing and settling. Keep the frozen baseline distinct from new design selection.

## BOLLEY

Own the [native backlog](https://github.com/aaaaaaaaaaaavm/BOLLEY/blob/main/OPEN_PROBLEMS.md) and follow its completion standard. Start from [CURRENT_REVIEW](https://github.com/aaaaaaaaaaaavm/BOLLEY/blob/main/docs/CURRENT_REVIEW.md): the selected 12-turn local-bridge/A5h geometry needs fresh field/circuit closure, supplier current-definition checks, hot switching/protection/parasitics and full thermal campaign, complete installed mass, tolerance/thermal/runout/structural evidence, end effects/handoffs/faults, six-degree-of-freedom release, retention and magnetic/EMC acceptance. P47 supplies the redesign mission trade instead of duplicating it. Fluxrelay, Fluxframe and Fluxpiston stay separate configurations.

## Prototype readiness

Provide evidence repair, BOLLEY electrical closure, existing-configuration physical models, structures/tolerances, thermal/materials, component accounting, controls/faults and test specifications. The redesign stream owns new VOLLEY mission/configuration integration. Combine them into one named buildable test article only after interfaces agree. Hardware/provider/customer/independent-review items remain externally dependent.

## Complete VOLLEY routing at 2026-09-15

Every live item is included below. Closure prepares evidence for programme decisions; the programme owner decides them. Reconcile this routing when the native register changes. Shared files follow [CONTINUITY](../CONTINUITY.md).

| VOLLEY ID | Owner | Native title | Native next step |
|---|---|---|---|
...
| E32 | Closure | Nothing inhibits the drive during the ascent pressure transit, and a fault there would break down: NEW 2026-08-10 | `COMPUTATION` — design the ascent inhibit and its fault logic |
| E33 | Closure | Magnet tolerance leaves a residual dipole that saturates the host's wheel in days, with the machine idle: NEW 2026-08-10 | `COMPUTATION` — magnet tolerance and the residual dipole |
