...
>
> And E28's central trade turns out not to be one. Across 350 to 450 km the 90-day plane spread
> moves 47.1° to 44.6°, about 5 %, while satellite life changes by 6.7x. At the shell spacing
...
| Inclination change, 1° | 133 m/s, A15 band 8 | No. 8.1x VOLLEY's entire shot, and beyond a spent stage's RCS |
...
| Deployer mass per 3U satellite | ~6 kg, canisterised class | 10.547 kg, VOLLEY loses, by 1.758x |

The lifetime figure is the one to read, not the velocity ratio. VOLLEY is 6.4x a spring on
raw Δv but 7.3-9.2x on what that Δv actually buys, because lifetime extension is superlinear
...
> 0.5-1.2 kg cold-gas module and beat VOLLEY on mass by about 8x.
...
|---|---|
| 3U / 6U | Per-satellite commanded velocity. Low count, high value each. Mass per satellite loses to a dispenser by 1.758x and to a propulsion module by 12.4x |
| 1U / PocketQube | Distribution at volume. Deployer mass per satellite falls by up to 30x, which is where the commercial argument actually closes |
