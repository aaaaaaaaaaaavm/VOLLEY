...
a different place, so its eleven live computation items are counted separately and left alone.
...
| [P79](../OPEN_PROBLEMS.md) / [E6](../OPEN_PROBLEMS.md) | [A75](../validation/A75_decay_density_calibration.md) has shown the disagreement is a level and not a form: E28's two GMAT reentries invert to uniform density scales of 1.9667 and 2.4443, agreeing to 1.2428x, and the headline is now a range -- 350 km is 29.0 to 36.0 d, 400 km 77.5 to 96.3, 450 km 195.1 to 242.5. What is left is the 1.2428x residual, which a scalar cannot carry and a variable-density atmosphere would explain, and the independent propagator check A9 specifies and this environment still cannot run |
