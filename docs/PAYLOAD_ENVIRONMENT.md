...
**Source:** `analysis/payload_environment.py` → `analysis/results/payload_environment.json`.
...
| z (mm) | **Peak field** | × Earth's field | × magnetometer full scale | Gradient dB/dz |
|---:|---:|---:|---:|---:|
| **20** — near face | **61.081 mT** | **1357×** | **611×** | **−17.14 mT/mm** |
| 30 | 7.827 mT | 174× | 78× | −1.19 mT/mm |
| 40 | 2.227 mT | 50× | 22× | −0.241 mT/mm |
| 50 | 0.887 mT | 20× | 8.9× | −0.064 mT/mm |
| 60 | 0.538 mT | 12× | 5.4× | −0.016 mT/mm |
| 70 — payload CoM | 0.463 mT | 10× | 4.6× | −0.004 mT/mm |
| 80 | 0.435 mT | 9.7× | 4.4× | −0.002 mT/mm |
| 90 | 0.414 mT | 9.2× | 4.1× | −0.002 mT/mm |
| 100 | 0.392 mT | 8.7× | 3.9× | −0.002 mT/mm |
| 110 | 0.367 mT | 8.2× | 3.7× | −0.003 mT/mm |
| **120** — far face | **0.341 mT** | **7.6×** | **3.4×** | −0.003 mT/mm |
...
of the payload is in a weak, almost gradient-free field that is still **4 to 10× Earth's**. That
...
| **Magnetorquer operation** | **Yes** | Cannot be commanded meaningfully against a 611× bias. Same class as above |
...
1. **A payload carrying an attitude magnetometer cannot use it inside this deployer.** 611× full
   scale at the near face, 3.4× at the far face. It will read saturated everywhere in the
