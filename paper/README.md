...
**Rebuilt 2026-08-13 (fourth pass)** from the current source with pdfTeX (TeX Live 2023):
**14 pages, zero undefined references, zero missing figures, zero errors.** Source and PDF agree. The one-page CV was
