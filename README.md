...
> sheets** covering 62 analyses A1–A65 — A3, A26 and A60 were numbered and never written —
...
| **looking for what is broken** | [`OPEN_PROBLEMS.md`](OPEN_PROBLEMS.md) — 141 numbered entries, 56 live. [`docs/KILL_CRITERIA.md`](docs/KILL_CRITERIA.md) — seven thresholds, three crossed |
...
| **Defect register** | **141 numbered entries, 56 live** — [`OPEN_PROBLEMS.md`](OPEN_PROBLEMS.md) |
| **Validation** | **65 run sheets**, 62 analyses across A1–A65 (A3, A26 and A60 were numbered and never written), each against a band declared *before* the run. **Three failed outright** |
