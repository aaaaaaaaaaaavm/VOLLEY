...
| **looking for what is broken** | [`OPEN_PROBLEMS.md`](OPEN_PROBLEMS.md) — 123 numbered entries, 51 live. [`docs/KILL_CRITERIA.md`](docs/KILL_CRITERIA.md) — seven thresholds, three crossed |
...
**Read [`docs/PROVENANCE.md`](docs/PROVENANCE.md) before citing any of it.** Fifty-eight validation
...
| **Defect register** | **123 numbered entries, 51 live** — [`OPEN_PROBLEMS.md`](OPEN_PROBLEMS.md) |
| **Validation** | **58 run sheets, A1–A59**, each against a band declared *before* the run. **Three failed outright** |
