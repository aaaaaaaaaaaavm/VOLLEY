...
| **looking for what is broken** | [`OPEN_PROBLEMS.md`](OPEN_PROBLEMS.md) — 135 numbered entries, 54 live. [`docs/KILL_CRITERIA.md`](docs/KILL_CRITERIA.md) — seven thresholds, three crossed |
...
| **Defect register** | **135 numbered entries, 54 live** — [`OPEN_PROBLEMS.md`](OPEN_PROBLEMS.md) |
