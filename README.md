...
| **looking for what is broken** | [`OPEN_PROBLEMS.md`](OPEN_PROBLEMS.md) — 130 numbered entries, 53 live. [`docs/KILL_CRITERIA.md`](docs/KILL_CRITERIA.md) — seven thresholds, three crossed |
...
| **Defect register** | **130 numbered entries, 53 live** — [`OPEN_PROBLEMS.md`](OPEN_PROBLEMS.md) |
