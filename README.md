...
>
> What that has produced, which is the part worth judging: 73 run sheets covering 70 analyses A1
...
| Validation | 73 run sheets, 70 analyses across A1 to A71 (A3, A26 and A60 were numbered and never written), each against a band declared before the run. Three failed outright |
